...
export const skillGroupInfo: Record<SkillGroup, SkillGroupInfo> = {
  ...
  [SkillGroup.DEVOPS]: {
    title: "DevOps",
    description: "Automating workflows, CI/CD pipelines, and ensuring smooth deployment processes for seamless delivery."
  },
  [SkillGroup.CLOUD]: {
...
export const frontend: Skill[] = [
  ...
  },
  {
    name: "Three.js",
    icon: "threejs",
    description: "For 3D graphics and immersive experiences.",
    groupType: SkillGroup.FRONTEND,
    skillType: SkillType.TO_LEARN,
  },
];
...
export const mobile: Skill[] = [
  ...
  },
  {
    name: "Swift",
    icon: "swift",
    description: "For iOS development.",
    groupType: SkillGroup.MOBILE,
    skillType: SkillType.TO_LEARN,
  },
];
...
export const devTools: Skill[] = [
  {
    name: "VS Code + Copilot Premium",
    description:
      "Boosts productivity. Feels like pair programming with an AI buddy.",
    icon: "vscode",
